  ...
  loadMaterialGUI(materials?: Material[]) {
    ...
    materials.forEach(material => {
      ...
      if (material instanceof PBRMaterial) {
        ...
        mode1.add(state, 'roughnessMetallicTexture', ['None', 'origin', ...Object.keys(this.textures)]).onChange(v => {
      ...
      // specular
        ...
        mode2.add(state, 'specularGlossinessTexture', ['None', 'origin', ...Object.keys(this.textures)]).onChange(v => {
